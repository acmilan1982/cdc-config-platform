...
> 新权威文档：`docs/database/RELATIONS.md`（跨表关系权威依据，逻辑关系 R01～R14）。
> 本快照为 2026-07-03 记录，含旧 10 表关系（CDC_SERVER / CDC_TOPIC_OFFSET 等），其中多数对象已不在当前 14 表使用范围内；关系编号与确认等级以 `RELATIONS.md` 为准。
