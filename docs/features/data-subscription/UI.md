...
| 依据的已批准需求基线 | `docs/features/data-subscription/REQUIREMENTS.md`（`DRAFT_PENDING_USER_REVIEW`（正式验收前 UI 交互基线对齐草案；上一正式批准需求版本为“取消并发保护”需求调整版本，107 条 `DSUB-REQ-001` ~ `DSUB-REQ-107`，Git 基线提交 `8331fbb6e17b8e2165b788d972f651aa980bf227`） |
