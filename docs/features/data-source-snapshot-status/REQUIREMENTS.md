...
- 需求编号：`DSS-REQ-001`～`DSS-REQ-083`，共 **83** 条，编号连续唯一（`DSS-REQ-001~065` 为已批准基线既有行；`DSS-REQ-066~071` 为第一轮 UI 调整草案新增行，见 §21，已随第一轮批准收口为基线；`DSS-REQ-072~075` 为第二轮 UI 调整草案新增行，见 §21.2，已随第二轮重新批准收口为基线；`DSS-REQ-076~083` 为 2026-09-10 隔离视觉原型 R2～R7 设计固化新增行，见 §21.4，已由 `DATA-SOURCE-SNAPSHOT-STATUS-PROTOTYPE-DESIGN-FREEZE-APPROVAL-001` 收口为 `APPROVED`）。
