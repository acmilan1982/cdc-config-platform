...
- **追踪更新**：本节对应新增需求 `DSS-REQ-088`/`DSS-REQ-089`（REQUIREMENTS §21.9）与新增验收 `DSS-AC-108~113`（ACCEPTANCE §4.23，全部 `NOT_RUN`）。§14.2 更新为 89/89、§14.3 更新为 113/113，**原映射行逐字节不变、仅追加**新映射（`DSS-REQ-088 ↔ DSS-AC-108/109/112/113`；`DSS-REQ-089 ↔ DSS-AC-110/111/112/113`）。
