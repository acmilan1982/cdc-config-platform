...
| 本轮（查询下拉固定宽度基线）正式实现状态 | `IMPLEMENTED_ACCEPTED`（`popper_width_formal_5173_implementation_status=IMPLEMENTED_ACCEPTED`、`popper_width_formal_code_review_status=APPROVED`、`human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER`，2026-09-12 经 `DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 复审收口为 `IMPLEMENTED_ADJUSTMENT_PENDING_FORMAL_ACCEPTANCE`；2026-09-12 前历史状态为 `IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW` + `popper_width_formal_code_review_status=CHANGES_REQUIRED`（ChatGPT 从远程 Git 对该实现提交的代码复审结论为 `CHANGES_REQUIRED`）+ 人工视觉/交互复审 `NOT_PASSED`）；已由独立实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-IMPLEMENTATION-001` 在 `5173` 正式前端按批准内容基准 `f74dd725682b745f1b8ac6a1b9358eff10aaddc2` 落地 `DSS-REQ-087` 固定宽度规则——只改 Feature 私有 `DataSourceSnapshotQueryBar.vue` 与其 `.spec.ts`，`frontend_code_diff` 仅限该 Feature 私有文件、`backend_code_diff=ZERO`，开发验证状态 `DEV_SELF_TEST_DONE`；ChatGPT 已按已批准 R2 支持边界从远程 Git 重新复审现有实现并给出 `APPROVED`，项目负责人已明确回复“人工检查了，没有问题”`human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER`；**该时点（2026-09-12 前历史）**`formal_acceptance_status=NOT_RUN`；当前（2026-09-13 最终接受收口后）`formal_acceptance_status=ACCEPTED`、`acceptance_execution_status=PASS`、`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`；`human_formal_5173_review_status=NOT_RUN_FOR_THIS_ADJUSTMENT`、`pending_user_review=NO`、`pending_user_confirmation_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`；本 Feature 已于 2026-09-13 经 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001` 最终接受收口为 `IMPLEMENTED_ACCEPTED`） |
| 本轮（查询下拉固定宽度基线）需求/验收计数 | 当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`），累计需求 `DSS-REQ-001~087` 共 87 条、验收 `DSS-AC-001~107` 共 107 条，追踪矩阵 87/87 与 107/107。历史：本轮新增需求 `DSS-REQ-087` 共 1 条、验收 `DSS-AC-104~107` 共 4 条，2026-09-12 前当时全部 `NOT_RUN`、`acceptance_not_run_count=107`（历史值）；基线均已收口为 `APPROVED`。见本文件 §21、`REQUIREMENTS.md` §21.8、`ACCEPTANCE.md` §4.22/§5 |
| 本轮（查询下拉固定宽度基线）下一入口 | `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001`（**历史（2026-09-14 本轮操作按钮 Loading 视觉稳定性实现任务提交后曾为本轮当前直接值，已由 R2 与 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 逐次纠正）**：本轮操作按钮 Loading 视觉稳定性文档 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-001` 已由 ChatGPT 从远程 Git 对 R1 纠正结果复审 `chatgpt_r1_review_status=APPROVED`、项目负责人明确回复“批准”`project_owner_approval_status=APPROVED`，并据此批准收口为 `action_button_loading_visual_stability_document_status=APPROVED`（批准日期 2026-09-14，批准内容基准提交 `c4d5c096a7428d7f5be1af0d776c53655dd86e26`）；该轮调整已由实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001` 于 2026-09-14 完成前端实现（`action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_FORMAL_ACCEPTANCE`（**历史（2026-09-14 R2 严格断言闭环更正任务提交后曾为 `action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`），已由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 收口**））；历史（2026-09-14 实现复审收口任务提交后）下一入口曾为 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001`（**历史（2026-09-14 实现复审收口任务提交后曾为本轮当前直接值；已于 2026-09-15 由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001` 建立的查询按钮与表格布局稳定性草案取代，本轮当前直接值见本文件 §1“查询按钮与表格布局稳定性草案下一入口”行）**；历史（2026-09-14 R2 严格断言闭环更正任务提交后曾为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`；2026-09-14 R1 实现任务后曾为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`），已由 R2 与 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 逐次纠正））。**历史（2026-09-14 批准收口前为 R1 复审入口 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL`（已由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-APPROVAL-001` 处理完毕）；再前截至 2026-09-14 本轮新增调整提出前为 `NONE_FEATURE_ACCEPTED`）**：本 Feature 已完成最终接受收口，不再有待复审或待验收入口；未来新增需求或调整必须另立独立任务并重新走正式流程。历史入口（R3 复审时点入口，已完成）：`CHATGPT_FORMAL_ACCEPTANCE_R3_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（ChatGPT 已从远程 Git 对 R3 结果提交 `68528cfec4db6c3eb92b0e24bff0b7b29f56006a` 复审 `APPROVED`，项目负责人明确回复“批准最终接受收口”）。其余历史入口（均已处理完毕）：`CHATGPT_FORMAL_ACCEPTANCE_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（R2 复审时点历史入口，已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001-R3` 承接纠正）→ `CHATGPT_FORMAL_ACCEPTANCE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（已处理完毕）→ `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001`（本轮界面规则已批准收口（`popper_width_document_status=APPROVED`）；批准收口任务 `...-BASELINE-APPROVAL-001`、R1 修正任务 `...-BASELINE-APPROVAL-001-R1` 与独立实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-IMPLEMENTATION-001` 均已完成，实现已在 `5173` 正式前端按批准内容基准 `f74dd725682b745f1b8ac6a1b9358eff10aaddc2` 落地 `DSS-REQ-087` 固定宽度规则（2026-09-12 前历史状态为 `popper_width_formal_5173_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`，其时代码复审结论为 `CHANGES_REQUIRED`，界面落点见 §21）；本 R2 任务提出支持视口边界修正（正式支持下限 `1280px`、`<1280px` 仅防御性观察、不计入正式验收），其文档已于 2026-09-12 经 `DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-BASELINE-R2-APPROVAL-001` 批准收口为 `popper_width_r2_document_status=APPROVED`（`chatgpt_r2_final_review_status=APPROVED`、`project_owner_r2_approval_status=APPROVED`，批准内容基准提交 `0666cd96f1f27784f6d77404bd8d4820dbd96013`）；2026-09-12 前历史入口为 `CHATGPT_POPPER_WIDTH_IMPLEMENTATION_REREVIEW_AGAINST_APPROVED_R2_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`，该入口已由 `DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 处理完毕（实现复审 `APPROVED`、人工视觉/交互复审 `APPROVED_BY_PROJECT_OWNER`）；该任务已于 2026-09-12 执行正式验收、并经 R1 完成 `DSS-AC-065` 定向补验，当前 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`、`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`，并已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001`（2026-09-13）最终接受收口）（历史：当时**不得**在本任务执行正式验收、107 条验收保持 `NOT_RUN`；该状态已由 2026-09-12 正式验收执行取代，当前 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`） |
...
下表为可机械/可人工验证的 UI 表现状态，供后续组件测试与浏览器人工验收定位（完整落点矩阵见 DESIGN §14；本表只列 UI 承担项）。全部用例在该设计时点当时 `NOT_RUN`（历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`），本设计不执行。
...
- 对应验收：`DSS-AC-069~080`（新增，见 ACCEPTANCE §4.18，该轮时点当时全部 `NOT_RUN`，历史值；当前 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`）；定向修订 `DSS-AC-026/027/068`。
...
- 实现状态当前 `IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`（第一轮 UI 调整已实现、待 ChatGPT 独立代码与证据复审与人工页面验收）、正式验收执行 `NOT_RUN`、当时 80 条 `DSS-AC-*` 保持 `NOT_RUN`、人工页面验收 `NOT_RUN`（第一轮时点状态，历史；其后第二轮草案时点验收 `DSS-AC-001~086` 共 86 条当时全部 `NOT_RUN`，见 §1/§16.9，属历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`））；当时下一入口为 ChatGPT 独立代码与证据复审、然后由项目负责人人工查看页面（历史入口，已处理完毕）；当前统一下一入口为 `NONE_FEATURE_ACCEPTED`（2026-09-13 最终接受收口后；历史入口 R3 复审时点入口 `CHATGPT_FORMAL_ACCEPTANCE_R3_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION` 已完成，R2 复审时点历史入口 `CHATGPT_FORMAL_ACCEPTANCE_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION` 已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001-R3` 承接纠正）。
...
- **对应验收**：新增 `DSS-AC-081~086`（ACCEPTANCE §4.19，全部 `NOT_RUN`），定向修订 `DSS-AC-020/022/026/027/038/039/040/041/042/073/074/075/076/077/080`。该小节时点（2026-09-08）当时全部 86 条 `DSS-AC-*` 保持 `NOT_RUN`（历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`））。
...
- 状态分离（批准收口后）：R2～R7 原型视觉方向＝`APPROVED_BY_PROJECT_OWNER`；R2～R7 固化文档＝`APPROVED`（2026-09-10 经 `DATA-SOURCE-SNAPSHOT-STATUS-PROTOTYPE-DESIGN-FREEZE-APPROVAL-001` 收口，批准内容基准提交 `e67b2ecc...`；固化时点为 `DRAFT_PENDING_USER_REVIEW`）；`5173` 对 R2～R7 的正式实现＝`PENDING_FORMAL_IMPLEMENTATION_ON_5173`、正式验收＝`NOT_RUN`。文档总体状态＝`PROTOTYPE_DESIGN_APPROVED_READY_FOR_FORMAL_5173_IMPLEMENTATION`；禁止写为 `FORMALLY_ACCEPTED`/`IMPLEMENTATION_APPROVED`/`ACCEPTANCE_PASSED`/`COMPLETED`（该小节时点（2026-09-10 前历史）：R2～R7 当时尚未应用到 `5173`、正式验收与人工视觉验收当时仍 `NOT_RUN`）。`DSS-AC-087~095` 当时全部 `NOT_RUN`（历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`））；`5174` 原型的 762 个前端测试与浏览器证据仅为设计验证证据，不得批量写成这些用例的 `PASS`。
...
- 自检：`DSS-REQ-076~083`、`DSS-AC-087~095` 编号连续、无重号、无复用；DESIGN §14.2 覆盖 83/83、§14.3 覆盖 95/95、无悬空；`DSS-AC-087~095` 当时全部 `NOT_RUN`（该自检时点（2026-09-10）历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`））；本轮不产生 `frontend/`/`backend/`/SQL/配置差异，不提交 runtime logs/截图/构建产物/依赖目录/临时文件。
...
- 批准收口记录（2026-09-10，`DATA-SOURCE-SNAPSHOT-STATUS-PROTOTYPE-DESIGN-FREEZE-APPROVAL-001`，纯文档）：ChatGPT 已从 Git 对批准内容基准提交 `e67b2ecc3897c3e83597126e259ee4c19349a66a` 完成最终复审 `APPROVED`，项目负责人于 2026-09-10 明确回复“批准”。据此把 §1 中 R2～R7 设计固化内容当前状态由 `DRAFT_PENDING_USER_REVIEW` 收口为 `APPROVED`，`5173` 对 R2～R7 的正式实现当时仍为 `PENDING_FORMAL_IMPLEMENTATION_ON_5173`、正式验收与 `5173` 人工视觉验收当时仍 `NOT_RUN`（该批准收口时点（2026-09-10）历史值；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`），人工视觉验收仍 `NOT_RUN`）；`pending_user_review=NO`、`pending_user_confirmation_count=0`。**业务零变化**：§19 界面数值/布局/Tooltip/响应式/交互规则、AI 计数（83/95）、`DSS-REQ-076~083` 与 `DSS-AC-087~095` 业务行、源库 Tooltip 口径（完整原始 `DATA_SOURCE_ID` only）均逐字节不变；`API.md`/`DATABASE.md` 契约零差异。**批准不代表 R2～R7 已应用到 `5173`、正式实现已完成或验收已通过，不等于 `IMPLEMENTED_ACCEPTED`**；下一入口为独立正式实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-PROTOTYPE-TO-FORMAL-IMPLEMENTATION-001`。
...
- 编号与追踪：`DSS-REQ-084~086`（累计 86 条）、`DSS-AC-096~103`（累计 103 条当时全部 `NOT_RUN`、`acceptance_not_run_count=103`，该小节时点（2026-09-10）历史值）；矩阵 86/86 与 103/103 双向无悬空；当前（2026-09-13 最终接受收口后）：`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`（`acceptance_execution_status=PASS`、`formal_acceptance_status=ACCEPTED`、`formal_acceptance_not_run_count=0`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`）（当前矩阵 87/87 与 107/107）；本轮界面规则已批准为 `APPROVED`，但禁止把已批准调整写成 `IMPLEMENTED`/`ACCEPTED`/`COMPLETED`，也不得把任何验收写成 `PASS`。
- 代码零差异：本轮不产生 `frontend/`/`backend/`/SQL/配置差异；`API.md`/`DATABASE.md` 与既有历史报告整文件逐字节不变。
- 分层状态：`query_control_interaction_adjustment_status=APPROVED`、`query_control_interaction_adjustment_implementation_status=IMPLEMENTED_ACCEPTED`（2026-09-12 经 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-CONTROL-INTERACTION-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 收口为 `IMPLEMENTED_ADJUSTMENT_PENDING_FORMAL_ACCEPTANCE`，2026-09-13 经 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001` 最终接受收口；2026-09-12 前历史状态为 `IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`）、`query_control_interaction_adjustment_code_review_status=APPROVED`（历史为 `PENDING_CHATGPT_REVIEW`）、`query_control_human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER`、`project_owner_visual_review_status=APPROVED_BY_PROJECT_OWNER`（历史为 `CHANGES_REQUIRED`）、`formal_5173_code_review_status=APPROVED`、**该时点（2026-09-12 前历史）**`formal_acceptance_status=NOT_RUN`、`acceptance_execution_status=NOT_RUN`、`formal_acceptance_not_run_count=107`；当前（2026-09-13 最终接受收口后）`formal_acceptance_status=ACCEPTED`、`acceptance_execution_status=PASS`、`DSS-AC-001~107` 共 107 条 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`、`formal_acceptance_not_run_count=0`；`pending_user_review=NO`、`pending_user_confirmation_count=0`。
...
- 本节为**纯文档批准收口**（`DATA-SOURCE-SNAPSHOT-STATUS-SELECT-POPPER-FIXED-WIDTH-BASELINE-APPROVAL-001`）：不生成截图、不修改任何代码、不执行正式验收（该批准收口任务时点（2026-09-11）`formal_acceptance_status=NOT_RUN`、`acceptance_not_run_count=107`，历史值）；prototype 的多视口/多状态自测与截图仅为**设计验证证据**，不得写成任何 `DSS-AC-*` 的 `PASS`。
...
## 22. R2 文档当前状态一致性纠正记录（`DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001-R2`）
...
- **该时点（2026-09-12 R2 任务时点，最终接受收口前）**统一验收事实（本文件与另 7 份入口文档一致）：`PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`、`acceptance_execution_status=PASS`、`formal_acceptance_status` 该时点为 `EXECUTED_PENDING_CHATGPT_REVIEW`（2026-09-13 已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001` 收口为 `ACCEPTED`）、`formal_acceptance_pass_count=107`、`formal_acceptance_fail_count=0`、`formal_acceptance_blocked_count=0`、`formal_acceptance_not_run_count=0`；验收基线批准状态仍 `acceptance_status=APPROVED`；`human_visual_acceptance_status` 该时点为 `NOT_RUN`（2026-09-13 已收口为 `APPROVED_BY_PROJECT_OWNER`），予以保留；`project_owner_visual_review_status=APPROVED_BY_PROJECT_OWNER`、`query_control_human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER`、`popper_width_human_review_status=APPROVED_BY_PROJECT_OWNER` 保持不变。
- **该时点（2026-09-12 R2 任务时点，最终接受收口前）**统一下一入口（本文件与另 7 份入口文档一致）：当时统一下一入口为 `CHATGPT_FORMAL_ACCEPTANCE_R3_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（R3 复审时点；当前统一下一入口为 `NONE_FEATURE_ACCEPTED`）；该 R2 记录时点统一下一入口为 `CHATGPT_FORMAL_ACCEPTANCE_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（历史，已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001-R3` 承接纠正）。历史入口（均已处理完毕，仅作历史保留）：`DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001`、`CHATGPT_FORMAL_ACCEPTANCE_REVIEW_FROM_GIT_THEN_TARGETED_COMPLETION_TASK`、`CHATGPT_FORMAL_ACCEPTANCE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`。
- 本文件实际修改点：§1 的 `acceptance_status`、`5173` 正式实现状态、文档总体状态、`本轮（查询控件交互调整基线）实现状态`、`本轮（查询控件交互调整草案）需求/验收计数`、两条 `下一入口`、`本轮（查询下拉固定宽度基线）正式实现状态`、`本轮（查询下拉固定宽度基线）需求/验收计数`、`本轮（查询下拉固定宽度基线）下一入口`；§13.8、§16.1、§16.9、§19.9、§20.7、§21.1 中的当前状态与下一入口表述；均为“前置当前值 + 显式历史限定”的补充，不删除任何真实历史。
- 零业务变化证明：`DSS-AC-001~107` 共 107 条验收业务行与批准内容基准 `bf5f1b5...` 逐字节一致；`DSS-REQ-001~087` 共 87 条需求业务行逐字节一致（需求 87/87 连续唯一）；§19～§21 界面业务规则（布局/数值/Tooltip/截断/响应式/交互）逐字节不变（仅状态前言/变更记录做最小同步）；`API.md`/`DATABASE.md` 契约与业务正文逐字节不变；`frontend/`/`backend/`/测试代码/验收证据/runtime 产物零改动；`dss_ac_065_status=PASS` 及其他 106 条验收状态零变化。
- 边界：本任务只做文档当前状态一致性纠正，**不作最终接受收口**、不把 Feature 标记为 `IMPLEMENTED_ACCEPTED`/`FORMALLY_ACCEPTED`、不代替项目负责人作正式接受决定、不修改 `human_visual_acceptance_status=NOT_RUN`、不重跑正式验收、不启停任何服务、不访问数据库/ZooKeeper/Kafka、不创建通用 UI 基线。

## 23. R3 当前直接值纠正记录（`DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-001-R3`）
...
- 本文件纠正 4 处直接值（行号以 `5ca9931...` 为参考）：`本轮（查询控件交互调整草案）需求/验收计数`、`本轮（查询下拉固定宽度基线）需求/验收计数`（现均前置 `DSS-AC-001~107` / `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`）、`本轮（查询控件交互调整基线）下一入口`、`本轮（查询下拉固定宽度基线）下一入口`（现均前置 R3 统一下一入口）；旧值作为历史后置保留，未删除任何真实历史。
- **该时点（2026-09-12 R3 任务时点，最终接受收口前）**统一验收事实（本文件与另 7 份入口文档一致）：`PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`、`acceptance_execution_status=PASS`、`formal_acceptance_status` 该时点为 `EXECUTED_PENDING_CHATGPT_REVIEW`（2026-09-13 已由 `DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001` 收口为 `ACCEPTED`）、`formal_acceptance_not_run_count=0`；`human_visual_acceptance_status` 该时点为 `NOT_RUN`（2026-09-13 已收口为 `APPROVED_BY_PROJECT_OWNER`），予以保留。
- **该时点（2026-09-12 R3 任务时点，最终接受收口前）**统一下一入口：`CHATGPT_FORMAL_ACCEPTANCE_R3_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION`（当前统一下一入口为 `NONE_FEATURE_ACCEPTED`）；R2 复审时点历史入口 `CHATGPT_FORMAL_ACCEPTANCE_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_ACCEPTANCE_DECISION` 已由本任务承接纠正。
- 零业务变化证明：`DSS-AC-001~107` 与 `DSS-REQ-001~087` 业务行、追踪矩阵、§19～§21 界面业务规则逐字节不变（相对 `5ca9931...`）；`API.md`/`DATABASE.md` 契约逐字节不变；`frontend/`/`backend/`/SQL/配置/测试零改动。
- 边界：本任务只做直接值顺序纠正，**不作最终接受收口**、不把 Feature 标记为 `IMPLEMENTED_ACCEPTED`/`FORMALLY_ACCEPTED`、不修改 `human_visual_acceptance_status=NOT_RUN`、不重跑正式验收。

## 24. 最终接受收口记录（`DATA-SOURCE-SNAPSHOT-STATUS-FORMAL-ACCEPTANCE-CLOSEOUT-001`）

> 纯文档正式验收最终接受收口任务，2026-09-13。本任务只把已发生的事实（R0→R1→R2→R3 正式验收与复审链、ChatGPT 对 R3 结果提交的远程 Git 复审 `APPROVED`、项目负责人明确回复“批准最终接受收口”）写入当前状态，不重跑验收、不修改代码/证据/业务规则/契约、不启停服务、不访问数据库/ZooKeeper/Kafka。

- 依据：ChatGPT 已从远程 Git 对 R3 结果提交 `68528cfec4db6c3eb92b0e24bff0b7b29f56006a` 独立正式复审 `APPROVED`；项目负责人明确回复“批准最终接受收口”。
- 收口结果（当前直接值，本文件与另 7 份入口文档一致）：`implementation_status=IMPLEMENTED_ACCEPTED`、`formal_acceptance_status=ACCEPTED`、`acceptance_execution_status=PASS`、`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER`、`project_owner_visual_review_status=APPROVED_BY_PROJECT_OWNER`、`formal_acceptance_pass_count=107`、`formal_acceptance_fail_count=0`、`formal_acceptance_blocked_count=0`、`formal_acceptance_not_run_count=0`；`requirements_status=APPROVED`、`acceptance_status=APPROVED`、`design_status=APPROVED`、`ui_status=APPROVED`；`pending_user_review=NO`、`pending_user_confirmation_count=0`。
- 计数与追踪：`DSS-REQ-001~087` 共 87 条、`DSS-AC-001~107` 共 107 条；追踪矩阵 87/87 与 107/107。
- 当前统一下一入口：`NONE_FEATURE_ACCEPTED`。本 Feature 已完成最终接受收口，不再有待复审或待验收入口；未来新增需求或调整必须另立独立任务并重新走正式流程。
- 人工接受含义：`human_visual_acceptance_status=APPROVED_BY_PROJECT_OWNER` 基于（1）项目负责人此前对含查询控件与 popper 修正的最终 `5173` 页面人工检查“人工检查了，没有问题”；（2）查询控件交互调整与 popper 固定宽度实现复审均收口 `APPROVED`；（3）正式验收最终 `DSS-AC-001~107` 共 107 条 `PASS`；（4）ChatGPT 对 R3 结果提交远程 Git 复审 `APPROVED`；（5）项目负责人本次明确批准最终接受收口。**不表示**项目负责人本次重新执行 107 条自动化验收，**也不表示**上述 107 条为 Agent 自测结果。
- 零业务变化：本任务仅同步 8 份入口文档的当前状态、当前描述、当前下一入口与最终接受收口记录；`DSS-REQ-001~087` 需求业务行、`DSS-AC-001~107` 验收业务行与状态列、DESIGN §14.2/§14.3 追踪矩阵、本文件 §19～§21 与 DESIGN §25～§27 业务规则正文、`API.md`/`DATABASE.md` 契约、`frontend/`/`backend/`/SQL/配置/测试/证据均逐字节不变。
- 服务与外部系统：本任务不启动/停止任何服务、不访问数据库/ZooKeeper/Kafka、不重跑 Maven/npm/Vitest/构建/浏览器验证、不重新注入 `DSS-AC-065` 临时数据、不修改既有 evidence。本 Feature 无 ZooKeeper 依赖，ZooKeeper 环境不参与本 Feature 的最终接受收口。

## 25. 操作按钮 Loading 视觉稳定性调整草案（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-001`）

> 2026-09-14 纯文档草案记录（界面规则草案）。已接受范围不受影响：`DSS-AC-001~107` 共 107 条保持 `PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`。本轮新增 `DSS-AC-108~113` 共 6 条已于 2026-09-14 由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001` 正式验收执行并全部 `PASS`（`action_button_loading_visual_stability_acceptance_not_run_count=0`；**历史（2026-09-14 正式验收执行前曾为 `NOT_RUN` 6 条、`action_button_loading_visual_stability_acceptance_not_run_count=6`）**）；本轮文档为 `DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`，实现 `PENDING_FORMAL_IMPLEMENTATION_ON_5173`。（**批准前历史状态**：本条为 2026-09-14 本轮操作按钮 Loading 视觉稳定性文档批准收口（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-APPROVAL-001`）前的历史记录；其中所载 `DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`、`pending_user_review=YES`、R1 复审入口 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL` 等状态均为批准收口前历史值，现分别为 `APPROVED`、`NO` 与正式实现任务入口 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001`。）

- **适用对象**：“查询”按钮（`DataSourceSnapshotQueryBar.vue`）与“立即刷新”按钮（`DataSourceSnapshotToolbar.vue`）。
- **四状态文字规则**：空闲 / Loading / 成功 / 失败四种状态下，按钮文字恒为 `查询` 与 `立即刷新`；**禁止**“查询中…”/“刷新中…”等动态文案，禁止文字长度随状态变化。
- **四状态按钮框规则**：四种状态下按钮框 `x`/`y`/`width`/`height` 变化量均为 `0px`。“查询”按钮宽度恒为 `62px`（已接受版本基准提交 `f3d383eb8b37b422033481a51acd89f0f28900cc` 的真实 Chromium 实测空闲宽度，四档正式支持视口 `1280×800`/`1700×920`/`1920×1080`/`2560×1440` 各 6 次采样、24/24 一致，`query_button_idle_measured_width_px=62`）；“立即刷新”按钮宽度恒为 `110px`（`refresh_button_fixed_width_px=110`）。按钮宽度在 Feature 私有命名空间内显式锁定（`width`/`min-width`/`max-width`/`flex-basis`），**不得**任意放大、**不得**回退为内容自适应宽度。
- **标签节点规则**：文字位于独立标签节点、固定居中，其中心点 `x`/`y` 在四种状态下零位移。
- **Loading 指示器规则**：指示器是 Feature 私有**常驻节点**，`position: absolute` 定位于文字左侧空白区，**不进入按钮内容流**、不影响按钮内容宽度；状态切换只改变可见性/透明度/旋转，不改变任何几何；颜色/尺寸沿用既有视觉基调，不引入新视觉体系；**不使用 `!important`**、不新增全局 `.el-button`/`.el-icon`/`.is-loading` 覆盖、不引入 JS 尺寸监听。
- **可访问性规则**：指示器 `aria-hidden="true"`、纯视觉、不产生重复读屏播报；Loading 期间按钮 `aria-busy=true`、结束后恢复；既有 `aria-disabled` 与事件防重复保护保留。
- **动效规则**：`prefers-reduced-motion: reduce` 下指示器可停止旋转，但必须保持静态可见、几何完全稳定。
- **状态独立性规则**：`queryLoading` 与 `manualLoading` 相互独立——查询不得点亮刷新指示器、刷新不得点亮查询指示器。
- **响应式规则**：既有 `1280px` 响应式换行规则保持不变；`1280×800` 可保留既有换行，但 Loading **不得**引起额外换行；“查询/重置”组、“刷新信息组”与查询栏高度在四档正式支持视口下的位置变化量为 `0px`。
- **不变项**：既有颜色/边框/圆角/字重/高度/hover/focus/disabled 样式与刷新逻辑分组几何均不变；请求状态机、完整原始查询值语义与四字段 `trim` + 20 Unicode 码点截断、`CLIENT_DESC` Tooltip、三个下拉触发控件固定宽度、三个 popper 固定宽度、`viewport width >= 1280px` 正式支持边界均不变。
- **状态与边界**（已由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-APPROVAL-001` 批准收口为 `APPROVED`，批准日期 2026-09-14，批准内容基准提交 `c4d5c096a7428d7f5be1af0d776c53655dd86e26`）：`action_button_loading_visual_stability_solution_direction_status=APPROVED_BY_PROJECT_OWNER`、`chatgpt_r1_review_status=APPROVED`、`project_owner_approval_status=APPROVED`、`action_button_loading_visual_stability_document_status=APPROVED`、`action_button_loading_visual_stability_requirements_status=APPROVED`、`action_button_loading_visual_stability_acceptance_baseline_status=APPROVED`、`action_button_loading_visual_stability_design_status=APPROVED`、`action_button_loading_visual_stability_ui_status=APPROVED`、`action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_FINAL_ACCEPTANCE`（**历史（2026-09-14 正式验收任务提交后曾为 `action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_FORMAL_ACCEPTANCE`）**）、`action_button_loading_visual_stability_code_review_status=APPROVED`、`action_button_loading_visual_stability_human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER`（**历史（2026-09-14 R2 严格断言闭环更正任务提交后曾为 `action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`、`action_button_loading_visual_stability_code_review_status=PENDING_CHATGPT_REVIEW`、`action_button_loading_visual_stability_human_visual_interaction_review_status=NOT_RUN`），已由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 收口**）、`action_button_loading_visual_stability_acceptance_status=EXECUTED_PENDING_CHATGPT_REVIEW`、`action_button_loading_visual_stability_acceptance_execution_status=PASS`、`action_button_loading_visual_stability_acceptance_pass_count=6`、`action_button_loading_visual_stability_acceptance_fail_count=0`、`action_button_loading_visual_stability_acceptance_blocked_count=0`、`action_button_loading_visual_stability_acceptance_not_run_count=0`、`formal_acceptance_pass_count=113`、`formal_acceptance_fail_count=0`、`formal_acceptance_blocked_count=0`、`formal_acceptance_not_run_count=0`、`requirements_count=89`、`acceptance_count=113`、`pending_user_review=NO`（**历史（2026-09-14 操作按钮 Loading 视觉稳定性文档批准收口时点的本轮直接值；已于 2026-09-15 由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001` 建立的查询按钮与表格布局稳定性文档取代（该文档已由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-APPROVAL-001` 于 2026-09-15 批准收口为 `query_button_and_table_layout_stability_document_status=APPROVED`），本轮当前直接值为 `pending_user_review=NO`，见本文件 §1“查询按钮与表格布局稳定性文档分层状态（本轮）”行与 §32）**）、`pending_user_confirmation_count=0`、`chatgpt_r0_formal_acceptance_review_status=CHANGES_REQUIRED_DOCUMENT_AND_EVIDENCE_FACT_CONSISTENCY_ONLY`（**历史（2026-09-14 R0 实现复审轮，ChatGPT 对该轮 R0 实现提交的复审结论曾为 `chatgpt_r0_implementation_review_status=CHANGES_REQUIRED`，其后已由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001-R1` 修复并经 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 复审收口为 `APPROVED`）**）、`current_next_entry=CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_FORMAL_ACCEPTANCE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_FINAL_ACCEPTANCE_DECISION`（**历史（2026-09-15 R1 文档与证据事实一致性纠正任务提交后曾为本轮当前直接值；已被本任务 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001` 于 2026-09-15 建立查询按钮与表格布局稳定性草案取代，该等待最终决定的入口不构成本轮当前直接值，本轮当前直接值见本文件 §1“查询按钮与表格布局稳定性草案下一入口”行）**；历史（2026-09-14 R0 正式验收提交后的历史入口，已由本 R1 纠正：`CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_FORMAL_ACCEPTANCE_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_FINAL_ACCEPTANCE_DECISION`；2026-09-14 实现复审收口任务提交后曾为 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001`；2026-09-14 R2 严格断言闭环更正任务提交后曾为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_R2_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`；2026-09-14 R1 实现任务后曾为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`），已由 R2、`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 与 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001` 逐次纠正）。统计读作“已接受范围 `DSS-AC-001~107` 共 107 条 PASS；本轮 `DSS-AC-108~113` 共 6 条已于 2026-09-14 由 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001` 正式验收执行并全部 PASS，合计 113 条 PASS”，但正式验收执行不等于最终接受（`action_button_loading_visual_stability_acceptance_status=EXECUTED_PENDING_CHATGPT_REVIEW`，待 ChatGPT 从远程 Git 复审后由项目负责人作最终接受决定），**不得**写成 `IMPLEMENTED_ACCEPTED`/`ACCEPTED`/`COMPLETED`。

## 26. R1 当前状态一致性纠正记录（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-001-R1`）

> 2026-09-14 纯文档定向纠正（不实现、不执行正式验收）：按 ChatGPT 对 R0 复审结论 `CHANGES_REQUIRED_CURRENT_STATUS_CONSISTENCY_ONLY` 纠正顶部当前状态冲突：`pending_user_review` 当前直接值前置为 `YES`（原 `NO` 作为“截至 2026-09-14 本轮新增调整提出前的上一已接受范围”历史保留）、当前统一下一入口前置为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL`（历史 `NONE_FEATURE_ACCEPTED` 与 R0 复审入口 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL` 均带日期限定保留），`current_next_entry=CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL`。§25 按钮 Loading 界面规则逐字节不变（本记录以新增小节追加，不改动 §25 正文）。（**批准前历史状态**：本条为 2026-09-14 本轮操作按钮 Loading 视觉稳定性文档批准收口（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-APPROVAL-001`）前的历史记录；其中所载 `DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`、`pending_user_review=YES`、R1 复审入口 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_APPROVAL` 等状态均为批准收口前历史值，现分别为 `APPROVED`、`NO` 与正式实现任务入口 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001`。）

## 27. 批准收口 R1 当前状态一致性纠正记录（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-BASELINE-APPROVAL-001-R1`）

> 2026-09-14 纯文档、极小定向事实一致性纠正（不实现、不执行正式验收、不改代码/契约）。ChatGPT 从远程 Git 对批准收口提交 `a43b45b0d2e8312c859d231fdfe3ed3505d209d6` 的复审结论为 `CHANGES_REQUIRED_DOCUMENT_CURRENT_STATUS_CONSISTENCY_ONLY`：批准决定、按钮业务规则、需求/验收业务行与 API/数据库边界本身无问题，仅有当前文档一致性残留。本 R1 仅纠正两项：① 三处 `pending_user_review` 当前直接值（`ACCEPTANCE.md` §1、`DESIGN.md` §1、`UI.md` §1 由 `YES` 改为 `NO`，原 `YES` 保留为带 2026-09-14 批准收口前限定的历史事实）；② `DESIGN.md` §14.2 标题计数（`87/87`→`89/89`）。§25 按钮业务规则逐字节不变，`DSS-REQ-001~089`、`DSS-AC-001~113` 业务行与状态列（`PASS 107 / FAIL 0 / BLOCKED 0 / NOT_RUN 6`）、API/数据库契约、前后端代码均未改变；批准决定未被撤销。当前下一入口已于 2026-09-14 本轮实现提交后更新为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`（本条记录为 2026-09-14 批准收口 R1 时点历史：当时下一入口为正式实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001`、本轮实现状态为 `PENDING_FORMAL_IMPLEMENTATION_ON_5173`）。

> 操作按钮 Loading 视觉稳定性前端实现记录（2026-09-14，`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001`，前端正式实现 + 自动化测试 + 构建 + 真实浏览器开发自测 + 实现状态文档同步；非正式验收、非最终收口）：本文件顶部当前状态据此推进为 `action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`、`action_button_loading_visual_stability_code_review_status=PENDING_CHATGPT_REVIEW`、`action_button_loading_visual_stability_human_visual_interaction_review_status=NOT_RUN`，当前下一入口为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_IMPLEMENTATION_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_VISUAL_INTERACTION_REVIEW`。本轮实现只改 Feature 私有前端组件与其测试（`frontend_code_diff=4_FILES`、`backend_code_diff=ZERO`）；§25 按钮业务规则正文逐字节不变。`DSS-AC-108~113` 共 6 条仍为 `NOT_RUN`（开发自测不等于正式验收）。（**历史（2026-09-14，实现复审收口任务提交后）**：本条为 R0 实现任务时点记录，其中分层状态（`action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`、`action_button_loading_visual_stability_code_review_status=PENDING_CHATGPT_REVIEW`、`action_button_loading_visual_stability_human_visual_interaction_review_status=NOT_RUN`）与“当前下一入口/下一入口”均为该时点直接值，已由 R2 与 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001` 逐次纠正为 `action_button_loading_visual_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_FORMAL_ACCEPTANCE`、`action_button_loading_visual_stability_code_review_status=APPROVED`、`action_button_loading_visual_stability_human_visual_interaction_review_status=APPROVED_BY_PROJECT_OWNER` 与 `DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001`；本记录其余事实保留。）
...
## 28. R2 严格断言闭环更正记录（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-001-R2`）
...
## 29. 操作按钮 Loading 视觉稳定性实现复审收口记录（DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-IMPLEMENTATION-REVIEW-CLOSEOUT-001）
...
## 30. 操作按钮 Loading 视觉稳定性正式验收执行记录（DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001）
...
## 31. 操作按钮 Loading 视觉稳定性正式验收 R1 文档与证据事实一致性纠正记录（`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001-R1`）

> 操作按钮 Loading 视觉稳定性正式验收 R1 文档与证据事实一致性纠正记录（2026-09-15，`DATA-SOURCE-SNAPSHOT-STATUS-ACTION-BUTTON-LOADING-VISUAL-STABILITY-FORMAL-ACCEPTANCE-001-R1`，纯文档与证据事实定向纠正；不重跑正式验收、不修改前端/后端/测试代码、不访问数据库/ZooKeeper/Kafka、不启停服务、不作最终接受收口）：按 ChatGPT 对 R0 正式验收提交 `eeafac6fb1030615bb17f21f35da9f2043597903` 的复审结论 `CHANGES_REQUIRED_DOCUMENT_AND_EVIDENCE_FACT_CONSISTENCY_ONLY`，本轮只纠正当前状态/统计/下一入口、`ACCEPTANCE.md` §4.23 现行事实、ZooKeeper 当前环境分层口径与 R0 负向自测退出码事实。本轮 R1 轮状态：`chatgpt_r0_formal_acceptance_review_status=CHANGES_REQUIRED_DOCUMENT_AND_EVIDENCE_FACT_CONSISTENCY_ONLY`、`r0_acceptance_execution_result_status=PRESERVED_PASS_6_OF_6_TOTAL_113_OF_113`、`r1_document_and_evidence_correction_status=COMPLETED_PENDING_CHATGPT_REVIEW`。当前下一入口统一为 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_FORMAL_ACCEPTANCE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_FINAL_ACCEPTANCE_DECISION`；R0 下一入口 `CHATGPT_ACTION_BUTTON_LOADING_VISUAL_STABILITY_FORMAL_ACCEPTANCE_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_FINAL_ACCEPTANCE_DECISION` 作为 2026-09-14 R0 正式验收提交后的历史入口保留（已由本 R1 纠正）。ZooKeeper 分层口径：`zookeeper_environment_status=AVAILABLE`（项目负责人提供的当前环境事实，本任务未主动连接验证）、`background_backend_zookeeper_session_status=OBSERVED_SESSION_ESTABLISHED_THEN_TIMEOUT_OR_RECONNECT`（后端后台组件既有会话，与本 Feature 无依赖关系）、`formal_acceptance_task_initiated_zookeeper_node_operation_status=NONE`、`zookeeper_write_status=NOT_REQUESTED`、`feature_zookeeper_dependency=NONE`。负向自测退出码事实：R0 `browser/harness/negative-selftest.mjs` 自身进程退出码实际为 `0`（该程序把“成功检测出 `0.001px` 变异”视为自测成功），R0 报告与本文件 R0 正式验收执行记录中关于“负向自测真实非零退出码”的表述均为证据事实错误；R1 已用页面无关 CLI（复用 R0 同一 `evaluateAcceptanceResult()`，不复制判断逻辑）以真实子进程退出码补强：R0 原始 `acceptance-matrix.json` 退出 `0`，注入恰好 `0.001px` 的负向控制 JSON 退出 `1` 并输出未舍入非零差值。§25 界面业务规则正文、`DSS-REQ-001~089` 与 `DSS-AC-001~113` 业务行及状态（`PASS 113 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`）、追踪 89/89 与 113/113、API/数据库契约、前后端与测试代码均逐字节不变（本记录以新增小节追加）。本轮尚未最终接受，待 ChatGPT 从远程 Git 复审 R1 后由项目负责人决定最终接受。（**历史（2026-09-15 操作按钮 Loading 视觉稳定性轮 §31 记录时点的表述；该等待最终决定的入口已由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001` 于 2026-09-15 建立的查询按钮与表格布局稳定性草案取代，不构成本轮当前直接值；本轮当前直接值见 §32 与 §1 对应行）**）

## 32. 查询按钮与表格布局稳定性调整草案界面规则（`DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001`）

> 本节为 2026-09-15 任务 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001` 新增的独立界面规则草案小节，对应 `REQUIREMENTS.md` §21.10 新增需求 `DSS-REQ-090`/`DSS-REQ-091` 与 `ACCEPTANCE.md` §4.24 新增验收 `DSS-AC-114~118`（5 条**全部** `NOT_RUN`）。**本节文档基线已由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-APPROVAL-001` 批准收口**：`query_button_and_table_layout_stability_document_status=APPROVED`（批准日期 2026-09-15，批准内容基准提交 `46d8aeb3fc3ec332788933635c47936592b70b1e`）；**当前事实（2026-09-15 R1 定向纠正任务提交并推送后）**：本轮实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-IMPLEMENTATION-001` 已在 `5173` 完成代码实现与开发自测（`query_button_and_table_layout_stability_implementation_status=IMPLEMENTED_ADJUSTMENT_PENDING_REVIEW`），但本轮 5 条新增验收 `DSS-AC-114~118` **仍全部 `NOT_RUN`**（**不得**把实现完成写成 `PASS`/`ACCEPTED`/`IMPLEMENTED_ACCEPTED`/`COMPLETED`）、Feature 最终接受收口未完成。**起草与批准时点历史（2026-09-15 草案建立至文档批准收口时点，该时点本轮尚未实现）**：该时点本节**未实现**（**不得**写成 `IMPLEMENTED`）、**未验收**（**不得**写成 `PASS`/`ACCEPTED`）、Feature 最终接受收口当时待独立正式实现任务 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-IMPLEMENTATION-001` 完成后另行收口（**批准前历史状态（2026-09-15 草案建立至本次批准收口前）**：当时本节为**纯文档草案**（`query_button_and_table_layout_stability_document_status=DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`），**未批准**、**未实现**、**未验收**，**已由批准收口处理完毕，不构成当前直接值**）。方向本身已由项目负责人确认（`query_button_and_table_layout_stability_solution_direction_status=APPROVED_BY_PROJECT_OWNER`），但确认方向不等于文档批准、更不等于实现或验收授权。

### 32.1 任务与范围

- 本轮只冻结两个已由项目负责人确认方向的界面调整：①“查询”与“重置”按钮固定 `62px` 宽（“立即刷新”保持 `110px`）；②在**真实主内容滚动容器**上、且**仅限本 Feature 路由**作用域内保留稳定纵向滚动条槽位，消除查询结果行数变化引起的弹性列及后续列水平位移。
- 本节为纯文档产出：不生成截图、不修改任何代码、不启动或停止任何服务、不执行正式验收；`DSS-AC-114~118` 全部 `NOT_RUN`（`query_button_and_table_layout_stability_acceptance_not_run_count=5`）。

### 32.2 冻结的按钮宽度规则（`DSS-REQ-090`，对应 `DSS-AC-114`）

- 查询区动作组三个按钮**不统一为同一宽度**，按职责分档：

  | 按钮 | 冻结宽度 | 说明 |
  |---|---|---|
  | 查询 | `width = min-width = max-width = flex-basis = 62px` | 主操作按钮；四属性同时约束，使 flex 分配与内容宽度均不能撑开或压缩它 |
  ...
  | 立即刷新 | `110px`（既有固定宽度，不变） | 沿用 `DSS-REQ-088`/`DSS-AC-108~113` 已验收的 `refresh_button_fixed_width_px=110` |

- **禁止**把查询/重置扩展到 `110px`；**禁止**把三个按钮统一到同一宽度；**禁止**只设 `width` 而放任 `min-width`/`max-width`/`flex-basis` 被内容或 flex 分配改写。
- 按钮高度、动作组间距与既有 Loading 视觉稳定性实现（DOM 常驻指示器、标签文字居中、`aria-busy`、`aria-hidden`、`prefers-reduced-motion`）**全部不变**；既有 `DSS-AC-108~113` 的 `PASS` 结论不得回退。

### 32.3 冻结的稳定滚动条槽位规则（`DSS-REQ-091`，对应 `DSS-AC-115`/`DSS-AC-116`）

- **真实根因（必须精确，不得错误归因）**：查询结果**行数变化**使主内容滚动容器的内容高度跨越“出现/消失纵向滚动条”的阈值 → 该容器 `clientWidth` 随滚动条出现/消失而增减 → Element Plus 重新分配弹性列宽 → 探针端等弹性列轻微变化，其后源库/快照状态/时间列随之水平位移。
- 汇总文字“共 N 条”（如“共 30 条”→“共 1 条”）**不是**直接根因；它至多经由页面高度/滚动条状态间接相关。**不得**把汇总文字写成直接根因，也**不得**以修改汇总文字作为修复手段。
- **冻结方案**：在**真实主内容滚动容器**上预留稳定纵向滚动条槽位，使用标准 CSS `scrollbar-gutter: stable`（首选）。要求：
  - 作用对象必须是本页**实际承载主内容滚动**的容器——**不是** Feature 页面根元素、**不是**结果卡片、**不是**表格外层框架；
  - **必须**限定在本 Feature/本路由（`/monitor/data-source-state`）作用域内：**不得**全局应用、**不得**影响其它路由的布局与滚动条呈现。

### 32.4 明确禁止的方案（`DSS-REQ-091`，对应 `DSS-AC-116`）

- **不得**伪造滚动内容：不加空白行、不加占位块、不设 `min-height` 以强行维持滚动条存在。
- **不得**使用 JS 宽度监听、`ResizeObserver` 宽度补偿、运行时表格宽度计算，或按结果行数切换像素值/样式的做法。
- **不得**把全局 `overflow-y: scroll` 作为默认手段。
- 上述禁止项与“作用域必须限定本 Feature 路由”共同构成 `DSS-REQ-091` 的实现边界；`DSS-AC-116` 判定禁止方案未被引入，`DSS-AC-118` 判定其它路由零影响。

### 32.5 表格列策略保持弹性（`DSS-REQ-091`，对应 `DSS-AC-117`）

- 表格列宽策略**保持既有弹性模型**（`DSS-REQ-072`/`DSS-REQ-079`：固定列 + 探针端/源库弹性列吸收剩余宽度），**不得**把所有列冻结为固定像素宽度。
- 本轮修复的**只是滚动条引起的容器可用宽度波动**：不改变任何列的固定/弹性归属，不改变 `49px` 行高、时间不省略、未知状态与源库表格 Tooltip 等既有展示规则。

### 32.6 几何判定与机器断言要求（`DSS-AC-115`/`DSS-AC-116`）

- **判定标准为严格 `0`**，不是“舍入后为 0”、不是“肉眼近似无位移”。在结果行数由多到少（滚动条由出现到消失）与由少到多（滚动条由消失到出现）两个方向的全过程中，下列几何量 delta 必须严格等于 `0`：
  1. 主内容滚动容器 `x`/`width`/`clientWidth`；
  2. Feature 页面根 `x`/`width`；
  3. 结果卡片 `x`/`width`；
  4. 表格外层框架 `x`/`width`；
  5. 每一个表头单元格 `x`/`width`；
  6. 每一个数据列起始 `x`；
  7. 探针端/源库/快照状态/三个时间列表头的**中心点**位置。
- 验证视口：`1280×800`、`1700×920`、`1920×1080`、`2560×1440`；正式支持最窄宽度为 `1280px`。
- 断言须以**机器可执行的几何断言**实现，并满足：① 通过时子进程退出码为 `0`；② 对注入 `0.001px` 的负向位移必须能真实识别并返回**非零**失败退出码（证明断言模块可失败，而非恒真）。
- 行数/位数边界覆盖：记录数 `0`/`1`，位数边界 `9/10`、`29/30`、`99/100`；并覆盖“未知状态”汇总徽标显示与不显示两种状态。

### 32.7 不变契约、取代关系与自检

- 取代/扩展关系：`DSS-REQ-090` 在既有按钮宽度口径（`DSS-REQ-088` 的“查询 `62px`/立即刷新 `110px`”）之上**新增**“重置固定 `62px`”并明确“不得统一为同一宽度”；`DSS-REQ-091` 为**新增**稳定性规则。两者均**不重写**任何既有需求业务行；完整取代/扩展说明见 `REQUIREMENTS.md` §21.10 与 `DESIGN.md` §38。
- 零接口/零契约变化：接口 `GET /api/monitor/data-source-run-state/list`、参数 `clientId`/`sourceId`/`status`、单飞行请求状态机、`60` 秒自动刷新、隐藏冻结/恢复补发、行键与排序常量、只读边界均不变；`api_contract_change_status=NONE`、`database_contract_change_status=NONE`、`database_write_status=NOT_REQUESTED`、`zookeeper_write_status=NOT_REQUESTED`。
- 编号与追踪：`DSS-REQ-090` ↔ `DSS-AC-114`/`DSS-AC-117`；`DSS-REQ-091` ↔ `DSS-AC-115`/`DSS-AC-116`/`DSS-AC-117`/`DSS-AC-118`（需求累计 91 条、验收累计 118 条，本轮 5 条全部 `NOT_RUN`）；既有 `DSS-REQ-001~089` 业务行与 `DSS-AC-001~113` 全部业务列/状态列**逐字节不变**，`DSS-AC-001~113` 保持 `PASS 113 / FAIL 0 / BLOCKED 0 / NOT_RUN 0`。
- 实现边界：限定 Feature 命名空间（Feature 私有 class 或 `scoped` 样式）最小特异性；**不得**使用全局 Element Plus 样式覆盖。
- 代码零差异（**自检时点：2026-09-15 草案建立与批准收口时点，该时点本轮尚未实现**）：该时点不产生 `frontend/`/`backend/`/测试/SQL/配置/依赖/锁文件差异（`frontend_code_diff=ZERO`、`backend_code_diff=ZERO`）；**该结论仅对该时点成立、不构成当前事实**——本轮实现已由 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-IMPLEMENTATION-001` 于 2026-09-15 修改 `frontend/src/views/data-source-run-state/components/DataSourceSnapshotQueryBar.vue` 与 `frontend/src/layouts/MainLayout.vue` 两个前端文件（其中 5 处为需求编号注释/测试名称纠正，`backend/`、SQL、配置、依赖与锁文件仍零差异），见文末实现记录。
- 待实现覆盖场景（本草案时点**未执行**）：滚动条出现/消失双向全过程几何严格 `0`；`1280px` 最窄支持宽度；其它路由在本 Feature 私有 gutter 生效后布局零影响；禁止方案未被引入。

### 32.8 变更记录

- 2026-09-15，新增 §32 与 §1 元数据行（“查询按钮与表格布局稳定性文档分层状态（本轮）”、“查询按钮与表格布局稳定性草案下一入口”），建立 `DSS-REQ-090`/`DSS-REQ-091` 与 `DSS-AC-114~118` 的界面规则草案（纯文档；文档未批准、未实现、验收未执行，Feature 最终接受收口暂缓）。
- 2026-09-15，查询按钮与表格布局稳定性 R1 文档口径纠正（`DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001-R1`，纯文档极小定向）：按 ChatGPT 从远程 Git 对 R0 草案提交 `be101a19558ae1ef1436bb3d61746dc21338e49a` 的独立复审结论 `chatgpt_r0_review_status=CHANGES_REQUIRED_TWO_DOCUMENT_WORDING_CONFLICTS_ONLY`（复审范围限定为**两项文档措辞冲突**，`business_direction_status=CORRECT_AND_PRESERVED`）执行两处纠正：① 统一“重置”按钮四属性锁定口径为 `width = min-width = max-width = flex-basis = 62px`（`UI.md` §32.2；R0 中“仅 `width = 62px`”属文档口径错误，R0 报告 §3.1 历史原文不改写，改在报告文末追加 append-only 纠正记录）；② 原位消除 `DSS-AC-114` 跨按钮坐标歧义——改为“每个按钮均以其自身空闲稳定态为基准，分别比较查询 Loading、查询成功、查询失败以及短结果/长结果状态；同一按钮在这些状态之间的 `x`/`y`/`width`/`height` 差值严格为 `0`。‘查询’和‘重置’只要求宽度同为 `62px`（宽度集合均为 `[62]`），二者各自的 `x` 坐标必须稳定，但不要求两个不同按钮的 `x` 坐标数值相同”，并明确“重置”自身无新增 Loading 状态、“立即刷新”以其自身空闲态为基准比较且宽度集合继续为 `[110]`；`DSS-AC-114` 状态仍为 `NOT_RUN`。业务方向、根因链（查询结果行数变化 → 真实主内容滚动容器纵向滚动条出现/消失 → `clientWidth` 变化 → Element Plus 重新分配弹性列宽）、`62/62/110px` 宽度决策、路由私有真实主滚动容器 `scrollbar-gutter: stable` 方案、需求 91、验收 118、追踪 `91/91` 与 `118/118`、既有 `DSS-AC-001~113` 全部 `PASS`、`DSS-AC-115~118` 全部 `NOT_RUN` 均未改变；`DSS-REQ-001~091` 业务行、`DSS-AC-001~113` 与 `DSS-AC-115~118` 完整行、`DESIGN.md` §38 业务规则、`UI.md` §32 除 §32.2“重置”行外业务规则、`DESIGN.md` §14.2/§14.3 映射行、API 与数据库业务正文逐字节不变；`frontend/**`、`backend/**`、测试、SQL、配置、依赖、锁文件、证据与其他既有报告零差异。本轮状态：`chatgpt_r0_review_status=CHANGES_REQUIRED_TWO_DOCUMENT_WORDING_CONFLICTS_ONLY`、`r1_document_wording_correction_status=COMPLETED_PENDING_CHATGPT_REVIEW`、`accepted_scope_acceptance_status=PASS_113`、`query_button_and_table_layout_stability_solution_direction_status=APPROVED_BY_PROJECT_OWNER`、`query_button_and_table_layout_stability_document_status=DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`、`query_button_and_table_layout_stability_implementation_status=PENDING_FORMAL_IMPLEMENTATION_ON_5173`、`query_button_and_table_layout_stability_code_review_status=NOT_RUN`、`query_button_and_table_layout_stability_acceptance_status=NOT_RUN`、`query_button_and_table_layout_stability_acceptance_not_run_count=5`、`pending_user_review=YES`、`pending_user_confirmation_count=0`。本草案**未批准**、**未实现**、**未验收**。§32 除 §32.2“重置”行外业务规则逐字节不变，§32.2 中“禁止只设 `width` 而放任其余三个属性被改写”规则保留不变；仅同步 §1 R1 分层状态、下一入口与本记录。当前下一入口统一为 `CHATGPT_QUERY_BUTTON_AND_TABLE_LAYOUT_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_DOCUMENT_APPROVAL`；R0 历史入口 `CHATGPT_QUERY_BUTTON_AND_TABLE_LAYOUT_STABILITY_BASELINE_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_DOCUMENT_APPROVAL` 作为 2026-09-15 历史值保留（**R0 历史入口，已由 R1 纠正任务处理**）。报告见 `docs/features/data-source-snapshot-status/reports/DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-001-R1.md`。**批准后历史限定（2026-09-15）**：本记录为 `DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-BASELINE-APPROVAL-001` 批准收口前的**批准前历史状态**；其中 `query_button_and_table_layout_stability_document_status=DRAFT_PENDING_CHATGPT_REVIEW_AND_PROJECT_OWNER_APPROVAL`、`pending_user_review=YES` 以及 R0/R1 复审入口 `CHATGPT_QUERY_BUTTON_AND_TABLE_LAYOUT_STABILITY_BASELINE_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_DOCUMENT_APPROVAL`／`CHATGPT_QUERY_BUTTON_AND_TABLE_LAYOUT_STABILITY_BASELINE_R1_REVIEW_FROM_GIT_THEN_PROJECT_OWNER_DOCUMENT_APPROVAL` 均为当时历史值，**已由批准收口处理完毕**，**不构成当前直接值**；本轮当前直接值见本文件状态表“查询按钮与表格布局稳定性文档分层状态（本轮）”行（`query_button_and_table_layout_stability_document_status=APPROVED`、`pending_user_review=NO`）与“查询按钮与表格布局稳定性草案下一入口”行（`DATA-SOURCE-SNAPSHOT-STATUS-QUERY-BUTTON-AND-TABLE-LAYOUT-STABILITY-IMPLEMENTATION-001`）。
