...
|---|--------|----------|----------|------|------|-----------|----------|----------|----------|----------|------|
| 1 | DATA_SOURCE_ID | 数据源 ID | el-input | 是 | 否 | — | 可修改 | 必填，最大32字符，唯一 | 是 | 是（精确） | 编辑时允许修改，需校验唯一性 |
...
| 编号 | 问题 | 分类 | 是否阻塞开发 |
|------|------|------|-------------|
| DS-Q-001 | 编辑时 DATA_SOURCE_ID 是否允许修改？ | 已确认：允许修改，需校验唯一性 | 否 |
| DS-Q-002 | SOURCE_APP 字段是否需要提供下拉选项？ | 已确认：自由输入 | 否 |
